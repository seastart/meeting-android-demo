 ...
 * description xml直接控制selector的EditText
 */
public class StateEditText extends AppCompatEditText {
    ...
    public StateEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.StateEditText);
        ...
        mNormalTextColor = a.getColor(R.styleable.StateEditText_normalTextColor, mDefaultNormalTextColor);
        mFocusTextColor = a.getColor(R.styleable.StateEditText_focusTextColor, mDefaultFocusTextColor);
        mPressedTextColor = a.getColor(R.styleable.StateEditText_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.StateEditText_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.StateEditText_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.StateEditText_normalBackgroundColor, 0);
        mFocusBackgroundColor = a.getColor(R.styleable.StateEditText_focusBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.StateEditText_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.StateEditText_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StateEditText_stateRadius, 0);
        mRound = a.getBoolean(R.styleable.StateEditText_stateRound, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.StateEditText_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.StateEditText_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.StateEditText_normalStrokeWidth, 0);
        mFocusStrokeWidth = a.getDimensionPixelSize(R.styleable.StateEditText_focusStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.StateEditText_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.StateEditText_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.StateEditText_normalStrokeColor, 0);
        mFocusStrokeColor = a.getColor(R.styleable.StateEditText_focusStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.StateEditText_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.StateEditText_unableStrokeColor, 0);
        setStroke();
